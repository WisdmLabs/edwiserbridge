...
class edwiserbridge_service_form extends moodleform
{
    public function definition() {
        ...
        // 5th field Token
        $mform->addElement('static', 'eb_mform_token_wrap', get_string('token', 'local_edwiserbridge'), '<b id="id_eb_token">' . $token_field . '</b>');
...
class edwiserbridge_summary_form extends moodleform
{
    public function definition() {
        global $CFG;
        $plugins_vdata = $this->get_plugin_version_data();
        $mform        = $this->_form;
